...
import 'package:planner/monthly_calendar_screen/models.dart';
import 'package:planner/monthly_calendar_screen/colors.dart';
import 'package:planner/monthly_calendar_screen/text_styles.dart';
...
class _Screen28State extends State<Screen28> {
  ...
  Future<void> _incrementCounter() async {
    ...
    List<String> celebrationsList = [
      // "День, когда стоит подумать о времени и о себе",
      "День высоких идеалов",
      "День фольклора",
      "День флирта",
      ...
      "Хозяйственный день",
      "День чудака",
      "День старого нового года",
      "День свободной печати",
      "День фигового листа",
      "День потомства",
      "День неудачника",
      "День человека",
      ...
      "День философа",
      "День культуры и отдыха",
      "День домашней хозяйки"
    ];
